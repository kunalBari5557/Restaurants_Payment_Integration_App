...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51NsMFASEC0VLWBPC1QUCZHjyemc8gAwmiQ1qSxOb0qDBge3HBpz9h3bwTfX0z3pCZm2LX39olSis6M9uWbSGLwSy00jaM5z5tA")
        const body = {
            products: carts
        }
        const headers = {
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right'><button onClick={makePayment} className='btn btn-success' type='button'>Checkout</button></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                }
